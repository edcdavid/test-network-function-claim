...
//
// Code generated by `test-network-function-claim/cmd/generate/generate.go` on: 2021-09-23 17:11:38.283597393 -0500 CDT m=+0.000602903
//
...
type Result struct {
	...
	// The file containing the Ginkgo test suite.
	Filename string `json:"filename"`

	// Whether the test is measuring elapsed time.
	IsMeasurement bool `json:"isMeasurement"`

	// The line number containing the Ginkgo.It test specification.
	LineNumber int `json:"lineNumber"`

	// Whether the Ginkgo.IT test specification passed or failed.
...
func (strct *Result) MarshalJSON() ([]byte, error) {
	...
	comma = true
	// "IsMeasurement" field is required
	// only required object types supported for marshal checking (for now)
	// Marshal the "isMeasurement" field
	if comma {
		buf.WriteString(",")
	}
	buf.WriteString("\"isMeasurement\": ")
	if tmp, err := json.Marshal(strct.IsMeasurement); err != nil {
		return nil, err
	} else {
		buf.Write(tmp)
	}
	comma = true
	// "LineNumber" field is required
	// only required object types supported for marshal checking (for now)
	// Marshal the "lineNumber" field
	if comma {
		buf.WriteString(",")
	}
	buf.WriteString("\"lineNumber\": ")
	if tmp, err := json.Marshal(strct.LineNumber); err != nil {
		return nil, err
	} else {
		buf.Write(tmp)
	}
	comma = true
	// "Passed" field is required
	// only required object types supported for marshal checking (for now)
	// Marshal the "passed" field
	if comma {
		buf.WriteString(",")
	}
	buf.WriteString("\"passed\": ")
	if tmp, err := json.Marshal(strct.Passed); err != nil {
		return nil, err
	} else {
		buf.Write(tmp)
	}
...
func (strct *Result) UnmarshalJSON(b []byte) error {
	...
	isMeasurementReceived := false
	lineNumberReceived := false
	passedReceived := false
	...
	for k, v := range jsonMap {
		...
		case "isMeasurement":
			if err := json.Unmarshal([]byte(v), &strct.IsMeasurement); err != nil {
				return err
			}
			isMeasurementReceived = true
		case "lineNumber":
			if err := json.Unmarshal([]byte(v), &strct.LineNumber); err != nil {
				return err
			}
			lineNumberReceived = true
		case "passed":
			if err := json.Unmarshal([]byte(v), &strct.Passed); err != nil {
				return err
			}
			passedReceived = true
		case "testText":
	...
	// check if filename (a required property) was received
	if !filenameReceived {
		return errors.New("\"filename\" is required but was not present")
	}
	// check if isMeasurement (a required property) was received
	if !isMeasurementReceived {
		return errors.New("\"isMeasurement\" is required but was not present")
	}
	// check if lineNumber (a required property) was received
	if !lineNumberReceived {
		return errors.New("\"lineNumber\" is required but was not present")
	}
	// check if passed (a required property) was received
	if !passedReceived {
		return errors.New("\"passed\" is required but was not present")
	}
